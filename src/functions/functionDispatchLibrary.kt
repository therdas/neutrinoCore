...
val functionMap: Map<Int, (Base8, BaseN) -> Boolean> = mapOf(
       ...
       /*LXI SP 16-bit*/0x31 to ::iLXI,
        ...
        /*PCHL*/        0xE9 to ::dummyFunction,
        /*POP B*/       0xC1 to ::dummyFunction,
        /*POP D*/       0xD1 to ::dummyFunction,
        /*POP H*/       0xE1 to ::dummyFunction,
        /*POP PSW*/     0xF1 to ::dummyFunction,
        /*PUSH B*/      0xC5 to ::dummyFunction,
        /*PUSH D*/      0xD5 to ::dummyFunction,
        /*PUSH H*/      0xE5 to ::dummyFunction,
        /*PUSH PSW*/    0xF5 to ::dummyFunction,
        /*RAL*/         0x17 to ::dummyFunction,
        /*RAR*/         0x1F to ::dummyFunction,
        /*RC*/          0xD8 to ::dummyFunction,
        /*RET*/         0xC9 to ::dummyFunction,
        /*RIM*/         0x20 to ::dummyFunction,
        /*RLC*/         0x07 to ::dummyFunction,
        /*RM*/          0xF8 to ::dummyFunction,
        /*RNC*/         0xD0 to ::dummyFunction,
        /*RNZ*/         0xC0 to ::dummyFunction,
        /*RP*/          0xF0 to ::dummyFunction,
        /*RPE*/         0xE8 to ::dummyFunction,
        /*RPO*/         0xE0 to ::dummyFunction,
        /*RRC*/         0x0F to ::dummyFunction,
        /*RST 0*/       0xC7 to ::dummyFunction,
        /*RST 1*/       0xCF to ::dummyFunction,
        /*RST 2*/       0xD7 to ::dummyFunction,
        /*RST 3*/       0xDF to ::dummyFunction,
        /*RST 4*/       0xE7 to ::dummyFunction,
        /*RST 5*/       0xEF to ::dummyFunction,
        /*RST 6*/       0xF7 to ::dummyFunction,
        /*RST 7*/       0xFF to ::dummyFunction,
        /*RZ*/          0xC8 to ::dummyFunction,
        /*SBB A*/       0x9F to ::dummyFunction,
        /*SBB B*/       0x98 to ::dummyFunction,
        /*SBB C*/       0x99 to ::dummyFunction,
        /*SBB D*/       0x9A to ::dummyFunction,
        /*SBB E*/       0x9B to ::dummyFunction,
        /*SBB H*/       0x9C to ::dummyFunction,
        /*SBB L*/       0x9D to ::dummyFunction,
        /*SBB M*/       0x9E to ::dummyFunction,
        /*SBI 8-bit*/   0xDE to ::dummyFunction,
        /*SHLD 16-bit*/ 0x22 to ::dummyFunction,
        /*SIM*/         0x30 to ::dummyFunction,
        /*SPHL*/        0xF9 to ::dummyFunction,
        /*STA 16-bit*/  0x32 to ::dummyFunction,
        /*STAX B*/      0x02 to ::dummyFunction,
        /*STAX D*/      0x12 to ::dummyFunction,
        /*STC*/         0x37 to ::dummyFunction,
        /*SUB A*/       0x97 to ::dummyFunction,
        /*SUB B*/       0x90 to ::dummyFunction,
        /*SUB C*/       0x91 to ::dummyFunction,
        /*SUB D*/       0x92 to ::dummyFunction,
        /*SUB E*/       0x93 to ::dummyFunction,
        /*SUB H*/       0x94 to ::dummyFunction,
        /*SUB L*/       0x95 to ::dummyFunction,
        /*SUB M*/       0x96 to ::dummyFunction,
        /*SUI 8-bit*/   0xD6 to ::dummyFunction,
        /*XCHG*/        0xEB to ::dummyFunction,
        /*XRA A*/       0xAF to ::dummyFunction,
        /*XRA B*/       0xA8 to ::dummyFunction,
        /*XRA C*/       0xA9 to ::dummyFunction,
        /*XRA D*/       0xAA to ::dummyFunction,
        /*XRA E*/       0xAB to ::dummyFunction,
        /*XRA H*/       0xAC to ::dummyFunction,
        /*XRA L*/       0xAD to ::dummyFunction,
        /*XRA M*/       0xAE to ::dummyFunction,
        /*XRI 8-bit*/   0xEE to ::dummyFunction,
